    ...
    PEBONA.instagramSettings = function() {
        if ($instagram.elExists()) {
            var feed = new Instafeed({
                get: 'user',
                userId: 16728263558,
                accessToken: '16728263558.1677ed0.17582d1897b34630b428631154aa62a3',
                target: 'instagram_feed',
                resolution: 'standard_resolution',
                limit: 9,
                template: '<figure class="swiper-slide"><a href="{{image}}" data-size="740x740"><img src="{{image}}"/></a><figcaption class="visually-hidden"><span>{{caption}}</span></figcaption></figure>',
